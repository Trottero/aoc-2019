...
namespace AOC_11_1.Tests
{
	...
	public class IntCodeComputerTests
	{
		...
		public void TestJumpInputZero_Returns_Zero_Position_Mode()
		{
			...
			Assert.AreEqual(0, intCodeComputer.ProgramOutput.Last());
		}
		...
		public void TestJumpInputNonZero_Returns_NonZero_Position_Mode()
		{
			...
			intCodeComputer.StartComputer();
			Assert.AreEqual(1, intCodeComputer.ProgramOutput.Last()) ;
		}
		...
		public void Test_Compares_Equal(string program, int input, int expectedOutput, string testName)
		{
			...
			intCodeComputer.StartComputer();
			Assert.AreEqual(expectedOutput, intCodeComputer.ProgramOutput.Last());
		}

		[TestMethod]
		[DataRow("109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99", 99, "Equal output")]
		[DataRow("1102,34915192,34915192,7,4,7,99,0", 1219070632396864, "Outputs a 16 bit number")]
