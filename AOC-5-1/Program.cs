...
namespace AOC_5_1
{
    class Program
    {
        ...
        static void ExecuteInstruction(int pos)
        {
            int[] amountofArgs = { 0, 3, 3, 1, 1, 2, 2, 3, 3 };
            int skippings = 0;
            // Expected to be atleast 2 numbers
            var instruction = split[pos].ToString();
            ...
            if (amountofArgs[instructionCode] == 1) // in and output
            {
                ...
                if (instructionCode == 4)
                {
                    ...
                    {
                        outputNum = split[pos + 1];
                    }
                    else
                    {

                        outputNum = split[split[pos + 1]];
                    }
                }
                skippings = 2;
            }
